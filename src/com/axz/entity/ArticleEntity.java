...
public class ArticleEntity {
    ...
    public ArticleEntity(int newsID, String newsTitle, String newsContent, String newDate, String newsDesc, String newsImagePath, int newRate, boolean newsIscheck, boolean newsIstop) {
        this.newsID = newsID;
